...
/**
 * Crea una tabla personalizada para su despliegue en la vista de las votaciones en curso.
 */
public class VotacionesTableModel extends AbstractTableModel {
    ...
    /**
     * Construye una tabla de tipo VotacionesTableModel.
     */
     ...
     * se obtienen los títulos de las votaciones y en la segunda columna se obtiene el texto correspondiente
     * a los botones.
     *
